...
class ContentsRVAdapter( val context : Context,
                         ...
                         val bookmarkList : MutableList<String> ) : RecyclerView.Adapter<ContentsRVAdapter.ViewHolder>()
{
    ...
    inner class ViewHolder( itemView : View ) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems( item : ContentModel, key : String ) {
            ...
            bookmarkArea.setOnClickListener {
                ...
                Log.d("ContentRVAdapter", FbAuth.getUid() )     // uid
                Log.d("ContentRVAdapter", key )                 // contents key
